...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        "Для ночного доступа в ПРАЧЕЧНУЮ САМООБСЛУЖИВАНИЯ, пожалуйста, отправьте свой контакт, "
        "нажав кнопку ниже, и Вам придет КОД ДОСТУПА.\n"
        "Введите его в кодонаборной панели на двери прачечной.",
